...
if (! function_exists('configure_database')) {
    function configure_database(&$ci_db_configuration, $db_config_name, $db_config) {
        ...
        $ci_db_configuration[$db_config_name]['autoinit'] = !DB_FAILOVER;
...
$unsharded_dbs = array(
    ...
    "shared_db" => array("localhost","shared_db"),
    "shared_db_slave" => array("localhost","shared_db"),
...
$shard_groups = array(
    ...
    "notification" => array(
        ...
        array("localhost", "guesswhat_notifications_2")
    )
);
...
$shard_backup_groups = array(
    "player" => array(
        ...
        array("localhost", "guesswhat_player_2_backup")
    )
);
