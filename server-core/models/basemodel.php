...
/******************************************************
 * An abstract class serving as base for all models in the application. 
 */
abstract class BaseModel extends CI_Model
{
	...
	/*************************************************************
	 * A method to create the object of current class
	 *
	 */
	...
	/************************************************
	 * Gets the db values for the fields defined in the class of given object
	 * 
	 * @param Object $obj
	 * return Array $data
	 */
	 ...
	 * Inserts the object if the id is not defined or force insert is true,
	 * Updates the record otherwise.
	 * 
	 * @param Object &$obj
	 ...
	 * 
	 * @param Object $obj
	 * @param Dictionary $extra_where_params
	 * return Array
	 */
    ...
    /**
     * Initialize the object to the default value specified by the fields
	 * in the object. The second parameter of the array is the default value
