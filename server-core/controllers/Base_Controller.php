...
/***********************************************
 * A base controller class extending REST_Controller
 * which loads needed helpers for controllers.
 * 
 * Use this as base class for all controllers
 */
class Base_Controller extends REST_Controller
{
	...
	/*******************************************
	 * A utility function to log request entry
	 * 
	 */
